        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {showFields.includes('storeCode') && (
            <div className="space-y-2">
              ...
              <Select value={filters.storeCode} onValueChange={(value) => handleFilterChange('storeCode', value)}>
                <SelectTrigger>
          ...
          {showFields.includes('subFormat') && (
            <div className="space-y-2">
              ...
              <Select value={filters.subFormat} onValueChange={(value) => handleFilterChange('subFormat', value)}>
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  {filterOptions.subFormats.map(subFormat => (
                    <SelectItem key={subFormat} value={subFormat}>{subFormat}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
            </div>
