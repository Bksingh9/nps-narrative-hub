    ...
    <Card className="mb-6">
      <CardContent className="p-4">
        <div className="flex flex-wrap items-center gap-4">
          ...
          {/* Store Filter */}
          <Select
            value={filters.selectedStore || 'all'}
            onValueChange={value => updateStore(value === 'all' ? '' : value)}
          >
          ...
          <Select
            ...
            onValueChange={value => updateState(value === 'all' ? '' : value)}
          >
          ...
          {/* Region Filter */}
          <Select
            value={filters.selectedRegion || 'all'}
            onValueChange={value => updateRegion(value === 'all' ? '' : value)}
          >
            <SelectTrigger className="w-[150px]">
          ...
          {cities.length > 1 && (
            <Select
              ...
              onValueChange={value => updateCity(value === 'all' ? '' : value)}
            >
              <SelectTrigger className="w-[150px]">
