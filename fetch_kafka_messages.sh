...
# Fetch Kafka messages from the Kafka UI endpoint
curl 'https://kafka-ui-m1.core.jiocommerce.io/api/clusters/sng-internal-kafka-cluster/topics/fynd-json-gringotts-payment_status/messages/v2?limit=100&mode=LATEST&keySerde=String&smartFilterId=dc1bc0db' \
...
echo "Data saved to filtered.json" 