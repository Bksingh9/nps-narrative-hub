...
# Fetch Failed Payment Messages from Kafka UI endpoint
echo "🔄 Fetching failed payment messages from Kafka..."

curl 'https://kafka-ui-m1.core.jiocommerce.io/api/clusters/sng-internal-kafka-cluster/topics/fynd-json-gringotts-payment_status/messages/v2?limit=100&mode=LATEST&keySerde=String&smartFilterId=dc1bc0db&activeFilterId=Failed' \
  ...
  -o failed_payments.json

echo "✅ Data saved to failed_payments.json" 